...
class DriftDrivenNode(PredictNode):
    ...
    def is_send(self) -> bool:
        if self.send_counter == 0:
            ...
            return True
        is_a = abs(self.last_datas[self.id]["alpha_hat"] - self.alpha_hat) > self.c_alpha1
...
if __name__ == "__main__":
    ...
    # Create the nodes
    nodes: list[DriftDrivenNode] = []
    for i in range(NODE_NUM):
        nodes.append(DriftDrivenNode(id=i, alpha=random.uniform(
